      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-card">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button type="submit" className="w-full bg-primary-mid hover:bg-primary-mid/90 text-primary-mid-foreground">
              Entrar
            </Button>
          </form>
          ...
          <div className="mt-6 text-center">
            <Link
              to="/registro"
              className="text-sm text-primary-mid hover:underline font-medium"
            >
